...
const IconHomeCloud = (props) => {
  return (
  	<svg className={props.className} xmlns="http://www.w3.org/2000/svg" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 32 32" width="512px" height="512px">
		<g>
