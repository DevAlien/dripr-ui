...
const IconHomeLaptop = (props) => {
  return (
  	<svg className={props.className} version="1.1" id="Livello_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
   viewBox="-208 210.3 141.7 141.7">
<g id="Livello_26">
